...
function getNLUInstance() {
    ...
    const NaturalLanguageUnderstandingImgV1 = require("ibm-watson/natural-language-understanding/v1")
    const { IamAuthenticator } = require("ibm-watson/auth")

    const naturalLanguageUnderstandingImgV1 = new NaturalLanguageUnderstandingImgV1({
        version: "2020-08-01",
    ...
    return naturalLanguageUnderstandingImgV1
